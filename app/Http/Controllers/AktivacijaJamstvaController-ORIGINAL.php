...
$aktivacije = KarticaVozila::where('userid', Auth::user()->id)->get()->sortByDesc("id");
        }
        else    
        {
            $aktivacije = KarticaVozila::where('sifra_avtohise', Auth::user()->sifra_avtohise)->get()->sortByDesc("id");
        }
    ...
    {         
        ...
        return view('aktivacija-dodaj', ['prodajalec' => $prodajalec, 'zv' => $znamkeVozil, 'prodajalci' => $prodajalci, 
                                            ...
                                            'k' => new KarticaVozila, 'urejanje'=>false]);
