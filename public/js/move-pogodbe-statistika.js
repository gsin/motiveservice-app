$(function() {
	...
	Highcharts.chart('container', {
		    ...
		    title: {
		        text: 'Število pogodb po paketih'
		    },
		    subtitle: {
		        text: 'Leto ' + leto,
		    },
		    ...
		    series: [ 
      		{
		        name: stat[0].paket,
		        data: [stat[0].januar, stat[0].februar, stat[0].marec, stat[0].april, stat[0].maj, stat[0].junij, stat[0].julij, stat[0].avgust, stat[0].september, stat[0].oktober, stat[0].november, stat[0].december],
		        color: '#338800',
