...
<p>
	...
	@elseif (strpos($k->tip_jamstva, 'INTENSA') !== false)
	     Posredovana aktivacija presega vstopne pogoje INTENSA.
		Storitve INTENSA se nanašajo na vozila do skupne mase 3,5 tone s polnim rezervarjem, ki niso bila prvič registrirana pred več kot 10 leti in nimajo več kot 180.000 prevoženih kilometrov (z besedo: sto osemdeset tisoč ).
	@elseif (strpos($k->tip_jamstva, 'PRIMA') !== false)
		Storitve PRIMA se nanašajo na vozila do skupne mase 3,5 tone s polnim rezervarjem, ki niso bila prvič registrirana pred več kot 12 leti in nimajo več kot 200.000 prevoženih kilometrov (z besedo: dvesto tisoč ).
	@elseif (strpos($k->tip_jamstva, 'SUPREMA') !== false)
	 	Storitve SUPREMA se nanašajo na vozila do skupne mase 3,5 tone s polnim rezervarjem, ki niso bila prvič registrirana pred več kot 7 leti in nimajo več kot 150.000 prevoženih kilometrov ( z besedo: sto petdeset tisoč).
	@endif
